...
class Kategori extends CI_Controller{
	...
	function detail(){
		...
		$data['title']='FM | Master Kategori - Detail';
		$hasil = $this->Kategori_model->getId($id);

		$data['kategori'] = $hasil->row_array();
	...
	function add(){
		$data['title']='FM | Master Kategori - Add';
	...
	function edit(){
		...
		$data['title']='FM | Master Kategori - Edit';
		$hasil = $this->Kategori_model->getId($id);
