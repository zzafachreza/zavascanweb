...
class Artikel extends CI_Controller{
	...
	function add(){
		$data['title']='FM | Master Artikel - Add';
	...
	function insert(){
        ...
        $sql="INSERT INTO data_artikel(judul,isi,foto) VALUES('$judul','$isi','$foto')";
	...
	function delete(){
        ...
        $this->db->query("DELETE FROM data_artikel WHERE id_artikel='$id'");
		unlink('upload/'.$foto);
		redirect('artikel');
	}
	...
	function edit(){
		...
		$data['title']='FM | Master Artikel - Edit';
		$hasil = $this->db->query("SELECT * FROM data_artikel WHERE id_artikel='$id'");
	...
	function update(){
		...
		if(empty($_FILES['foto']['name'])){
	    	...
	    	if(!empty($foto)){
			 $sql= "UPDATE data_artikel SET 
			 
			judul='$judul',
            isi='$isi',

			 foto='$foto' WHERE id_artikel='$id'";
		}else{
