...
$sql="SELECT * FROM barcode_$id_member a WHERE status=2 ORDER BY tanggal_ekspedisi DESC, jam_ekspedisi DESC limit 10";
	  		...
	  		<tbody>
		  		...
		  		?>
		  			...
		  			<td><?php echo $no ?></td>
		  			  ...
		  			  <td><?php echo $row->tanggal_ekspedisi  ?> <?php echo $row->jam_ekspedisi ?></td>
		  			<td><?php echo $row->by_ekspedisi ?></td>
