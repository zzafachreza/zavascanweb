...
<div class="container-fluid">
	...
	<div class="card">
	  ...
	  <form action="<?php echo site_url('brand/insert') ?>" method="POST" enctype="multipart/form-data">

	<a href="<?php echo site_url('brand') ?>" class="AppButton-dark"><i class="flaticon2-left-arrow-1"></i> Kembali</a>
