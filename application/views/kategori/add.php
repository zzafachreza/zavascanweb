...
<div class="container-fluid">
	...
	<div class="card">
	  ...
	  <form action="<?php echo site_url('kategori/insert') ?>" method="POST" enctype="multipart/form-data">

	<a href="<?php echo site_url('kategori') ?>" class="AppButton-dark"><i class="flaticon2-left-arrow-1"></i> Kembali</a>
  	...
  	<button  class="AppButton-primary" id="simpan" type="SUBMIT"><i class="flaticon2-files-and-folders"></i> Simpan</button>
	  	...
	  	<div class="card-body">
			 ...
			 <table class="table">
			   ...
			   <tr><th>Nama Kategori</th><td><input autocomplete='off' type='text' name='nama_kategori' class='form-control'></td></tr>
