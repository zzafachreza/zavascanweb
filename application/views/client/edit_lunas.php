<div class="container-fluid">
	  ...
	  <form action="<?php echo site_url($modul.'/update_invoice_lunas') ?>" method="POST" enctype="multipart/form-data">
    ...
    ?>
	  		    ...
	  		    <div class="form-group">
	  		            ...
	  		            <div class="form-group">
        	  		        <label>Status</label>
        	  		        <input readonly class="form-control" name="status_invoice" value="SUDAH BAYAR PELUNASAN">
        	  	
        	  		    </div>
        	  		    
	  		        <div class="form-group">
    	  		        <label>Tanggal Pelunasan</label>
    	  		        <input class="form-control" name="tanggal_3" type="date" value="<?php echo date('Y-m-d') ?>" />
    	  		    </div>
	  		    ...
	  		    <div class="col-sm-6">
    	  		        ...
    	  		        <input id="termin" readonly class="form-control uang" name="bayar_2" type="text" required autocomplete="off" value="<?php echo $i->bayar_2 ?>" />
        	  		    </div>
    	  		    
    	  		      <div class="form-group">
    	  		        <label>Pembayaran Pelunasan</label>
    	  		        <input id="lunas" class="form-control uang" name="bayar_3" type="text" required autocomplete="off" autofocus />
        	  		    </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#lunas").keyup(function(){
            ...
            var lunas = parseFloat($("#lunas").val().replace(",","").replace(",","").replace(",",""));
            var sisa = ((total - dp)-termin)-lunas;
