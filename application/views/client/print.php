        ...
        <table cellpadding="1" style="font-size:small">
            ...
            <tr>
             ...
             <tr>
                ...
                <td>:</td>
                <td><strong><?php echo Indonesia3Tgl($r->tanggal_3) ?></strong></td>
            </tr>
  ...
  <table style="border-collapse: collapse;;margin-top:3%;margin-bottom:3%" cellspacing="3" cellpadding="3" width="100%" border="1">
         ...
         ?>
           <tr>
             ...
             <td style="font-size:small;text-align:center"><?php echo number_format($r->bayar_2) ?></td>
         </tr>
         <?php
            }
         ...
         ?>
           <tr>
             <td  style="font-size:small">Pelunasan</td>
             <th style="font-size:large;text-align:right"><?php echo number_format($r->bayar_3) ?></th>
         </tr>
              <tr>
        ...
        <p  style="font-size:x-small"><i>*Keterangan: Maintenance, Hosting, Domain dan SSL gratis untuk tahun pertama, untuk tahun selanjutnya dikenakan biaya Rp. <?php echo number_format(($r->harga_total*0.1) + $r->hosting_domain) ?></i> </p>
        ...
        <p  style="font-size:x-small">Make all check payable to ZAVALABS</p>
        
        <p  style="font-size:x-small">If you have any questions concerning this invoice, use the following contact information to +62813-1945-6595 Payment Transfer to :</p>
            ...
            <table width="100%" style="border-collapse: collapse;text-align:center;margin-top:3%;margin-bottom:3%">
             ...
             <table width="100%" style="border-collapse: collapse;text-align:center;margin-top:3%;margin-bottom:3%">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><p style="font-size:12px;text-align:left;border-bottom:1px dashed black;width:100%"><?php echo angkaTerbilang($r->bayar_3) ?> Rupiah</p></td>
                </tr>
                <tr>
                    <td><p style="font-size:12px;text-align:left;">Untuk Pembayaran</p></td>
                    <td>:</td>
                    <td><p style="font-size:12px;text-align:left;border-bottom:1px dashed black;width:100%">Pelunasan Aplikasi <?php echo $r->nama_aplikasi ?></p></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
             ...
             <table width="100%" style="border-collapse: collapse;text-align:center;margin-top:3%;margin-bottom:3%">
                ...
                <tr>
                    <td width="35%"><p style="font-size:30px;text-align:center;margin-top:0%;padding-left:5%;font-weight:bold;border:1px solid black;border-radius:10px">Rp. <?php echo number_format($r->bayar_3) ?></p></td>
                    <td></td>
                     <td width="30%">
                         <p style="font-size:12px;text-align:right;width:100%">Bandung, <?php echo Indonesia3Tgl($r->tanggal_3) ?></p>
