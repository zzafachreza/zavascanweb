        ...
        <table cellpadding="1" style="font-size:small">
            ...
            <tr>
             ...
             <tr>
                <td>Tanggal DP</td>
                <td>:</td>
                <td><strong><?php echo Indonesia3Tgl($r->tanggal_1) ?></strong></td>
            </tr>
  ...
  <table style="border-collapse: collapse;;margin-top:3%;margin-bottom:3%" cellspacing="3" cellpadding="3" width="100%" border="1">
         ...
         <tr>
           ...
           <tr>
             ...
             <th style="font-size:large;text-align:left"><?php echo number_format($r->bayar_1) ?></th>
         </tr>
            ...
            <table width="100%" style="border-collapse: collapse;text-align:center;margin-top:3%;margin-bottom:3%">
             ...
             <table width="100%" style="border-collapse: collapse;text-align:center;margin-top:3%;margin-bottom:3%">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><p style="font-size:12px;text-align:left;border-bottom:1px dashed black;width:100%"><?php echo angkaTerbilang($r->bayar_1) ?> Rupiah</p></td>
                </tr>
                <tr>
                    <td><p style="font-size:12px;text-align:left;">Untuk Pembayaran</p></td>
                    <td>:</td>
                    <td><p style="font-size:12px;text-align:left;border-bottom:1px dashed black;width:100%">Pembayaran DP Aplikasi <?php echo $r->nama_aplikasi ?></p></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
             ...
             <table width="100%" style="border-collapse: collapse;text-align:center;margin-top:3%;margin-bottom:3%">
                ...
                <tr>
                    <td width="35%"><p style="font-size:30px;text-align:center;margin-top:0%;padding-left:5%;font-weight:bold;border:1px solid black;border-radius:10px">Rp. <?php echo number_format($r->bayar_1) ?></p></td>
                    <td></td>
                     <td width="30%">
                         <p style="font-size:12px;text-align:right;width:100%">Bandung, <?php echo Indonesia3Tgl($r->tanggal_1) ?></p>
