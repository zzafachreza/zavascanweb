<div class="container-fluid">
	  ...
	  <form action="<?php echo site_url($modul.'/update_invoice_dp') ?>" method="POST" enctype="multipart/form-data">
    ...
    ?>
	  		    ...
	  		    <div class="form-group">
	  		            ...
	  		            <div class="form-group">
        	  		        <label>Status</label>
        	  		        <input readonly class="form-control" name="status_invoice" value="SUDAH BAYAR DP">
        	  	
        	  		    </div>
        	  		    
	  		        <div class="form-group">
    	  		        <label>Tanggal Down Payment</label>
    	  		        <input class="form-control" name="tanggal_1" type="date" value="<?php echo date('Y-m-d') ?>" />
    	  		    </div>
                   ...
                   <div class="row">
                        ...
                        <div class="form-group col-sm-6">
    	  		        ...
    	  		        <input id="dp" class="form-control uang" name="bayar_1" type="text" required autocomplete="off" autofocus />
        	  		    </div>
