...
<div class="expired">
  ...
  <div class="message">
    <h1>Maaf, akun Anda sudah expired</h1>
    <p></p>
    <a style="background:#25d366;padding:3%;color:white;border-radius:10px;text-decoration:none;font-size:xx-large" href="https://wa.me/6281319456596" target="_blank">Hubungi admin Zavalabs untuk perpanjang</a>
    <div style="height:60px"></div>
     <a style="background:#FECC00;padding:3%;margin-top:10%;color:#000;border-radius:10px;text-decoration:none;font-size:xx-large" href="https://wa.me/6281319456596" target="_blank"><img style="padding-top:10px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/1200px-WhatsApp.svg.png" width="30" />Klik disini</a>
  </div>
