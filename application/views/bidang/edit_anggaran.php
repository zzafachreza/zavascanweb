<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active" aria-current="page">Edit - Anggaran</li>
	  </ol>
</nav>
<div class="container-fluid">
	...
	<div class="card">
	  ...
	  <form action="<?php echo site_url('bidang/update_anggaran') ?>" method="POST" enctype="multipart/form-data">
  	...
  	<button  id="simpan" type="SUBMIT" class="btn bg-utama" ><i class="flaticon2-download-2"></i> Simpan</button>
	  	...
	  	<div class="card-body">
	  	    ...
	  	    $bidangHD = $this->db->query("SELECT * FROM data_bidang WHERE id='$id_bidang'")->row_array();
	  	     ...
	  	     $sqlKegiatan ="SELECT * FROM data_anggaran WHERE id_bidang='$id_bidang' AND id='$id'";
			 ...
			 <table class="table">
                ...
                <tr><th width="40%">Anggaran</th><td><input autofocus="autofocus" autocomplete='off' type='text' name='anggaran' class='form-control' value="<?php echo $kegiatan['anggaran'] ?>" ></td></tr>
                   <tr><th>Bulan</th><td>
