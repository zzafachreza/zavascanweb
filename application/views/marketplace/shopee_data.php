<div class="container-fluid">
    <form method="POST" action="shopee_excel">
...
<div class="row">
    <div class="col col-sm-2">
        <a class="btn bg-utama col-sm-12 text-white" style="color:white;background:#FC5A31" href="<?php echo site_url() ?>/import_shopee?ref_member=<?php echo $_SESSION['id'] ?>">Fitur Import Shopee</a>
     </div>
    ...
    <div class="col col-sm-2" style="padding-bottom:1%">
        <a onClick="return confirm('Sebelum di clear pastikan data sudah di doenload terlebih dahulu ya..')" href="<?php echo site_url() ?>/marketplace/shopee_clear/<?php echo $_SESSION['id'] ?>" class="btn bg-danger col-sm-12 text-white" style="border-radius:0px">Clear Data Marketpalce</a>
    </div>
</div>
	  	<div id="data">
